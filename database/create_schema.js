...
let photosJson = null;
let password = ["12345", "abcde", "67890", "12345", "abcde", "67890", "12345", "abcde", "67890", "abcde"];
...
//   FOREIGN KEY (postId) REFERENCES posts(userId)    FOREIGN KEY (id) REFERENCES users(id)
let dataBase = async () => {
